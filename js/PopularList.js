...
var republicansAndDemocratsCount = function(){

  $.ajax({
            url: "js/topCandidateCounts.jag",
            dataType: "json",
            type: "GET",
            success: function(data){
...
var candidatePopularHashTags = function(){
  $.ajax({
            url: "js/PopularCandidateHtags.jag",
            dataType: "json",
            type: "GET",
            success: function(htags){
             $("#cHashTags1").html(htags[0]+htags[4]+htags[8]+htags[12]+htags[16]);  
             $("#cHashTags2").html(htags[1]+htags[5]+htags[9]+htags[13]+htags[17]);
             $("#cHashTags3").html(htags[2]+htags[6]+htags[10]+htags[14]+htags[18]);
             $("#cHashTags4").html(htags[3]+htags[7]+htags[11]+htags[15]+htags[19]); 
             },
            error: function(e){
...
var getfbMentionCount = function(){

  $.ajax({
            url: "js/fbCandidateCount.jag",
            dataType: "json",
            type: "GET",
            success: function(data){
             
               // alert(JSON.stringify(data));
                $("#div31").html(NumFor(data[0]));
                $("#div32").html(NumFor(data[1]));
                //$("#div3").html(NumFor(data[2]));
                $("#div41").html(NumFor(data[3]));
                $("#div42").html(NumFor(data[4]));
                //$("#div4").html(NumFor(data[5]));
             },
            error: function(e){
 ...
 $.ajax({   
	    ...
	    var data =  [
                        ...
                        var config = {
                          x : "Date",
                          charts : [
                            {axesColor:"#FFFFFF", titleFontColor:"#FFFFFF", legendTitleColor:"#FFFFFF", legendTextColor:"#FFFFFF",type: "line",padding: {"top": 10, "left": 50, "bottom": 100, "right": 100},xAxisAngle:true, y : "Rate", color: "Candidate",colorDomain:["TRUMP","CLINTON","BERNIE","CRUZ"], colorScale:["#fa574b","#3ec2ee","#1c40fb","#e51000"],tooltip: {"enabled":true, "color":"#e5f2ff", "type":"symbol", "content":["News1","News2","News3"], "label":true}}
                          ],
                          width: wit*0.95,
                          height: hight*0.95,
                          xFormat:"%m/%d/%Y",
...
//alert(JSON.stringify(data));
	    ...
	    var data =  [
                        ...
                        var config = {
                          x : "Date",
                          charts : [
                            {axesColor:"#FFFFFF", titleFontColor:"#FFFFFF", legendTitleColor:"#FFFFFF", legendTextColor:"#FFFFFF",type: "line",padding: {"top": 10, "left": 50, "bottom": 100, "right": 100},xAxisAngle:true, y : "Rate", color: "Candidate",colorDomain:["TRUMP","CLINTON","BERNIE","CRUZ"], colorScale:["#fa574b","#3ec2ee","#1c40fb","#e51000"]}
                          ],
                          width: wit*0.95,
                          height: hight*0.95,
                          xFormat:"%m/%d/%Y",
