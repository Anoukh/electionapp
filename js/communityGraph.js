          ...
          var tip = d3.tip()
           ...
           svg.call(tip); 
            ...
            var tableNodes=[],tableEdges=[];
                 ...
                 var nodeUrl1 = "https://52.207.239.223:9451/analytics/tables/NEWELECNODES",
                     edgeUrl1 = "https://52.207.239.223:9451/analytics/tables/NEWELECEDGES" ;
...
console.log("Node:"+dataN1.length);
				...
				//	if(d.name==='realDonaldTrump' && d.party==='CRUZ'){
                                   // console.log(d);
				  //  continue;
				//	}
                                      Nodes.push(d);
...
//alert("Drawinggggggggggggggggggggggggggggg");
